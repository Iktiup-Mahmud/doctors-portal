...
const AvailableAppoinments = ({selectedDate}) => {
    ...
    return (
        <div className='mx-10 my-20'>
            <div>
                {
                    selectedDate
                        ...
                        :
                        <p className='text-center text-2xl text-secondary font-bold'>Please select a date</p>
                }
            </div>
            ...
            {
                treatement && 
                <BookingModal treatement={treatement} setTreatement={setTreatement} selectedDate={selectedDate} ></BookingModal>
            }
        </div>
